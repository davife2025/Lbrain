...
export default function LiveTickerStrip() {
    ...
    return (<div style={{ overflow: 'hidden', borderBottom: '1px solid var(--border)', background: 'var(--bg2)', padding: '6px 0' }}>
      <div ref={trackRef} style={{ display: 'flex', gap: 0, width: 'max-content' }}>
        {items.map((sym, i) => {
            ...
            const up = change >= 0;
            return (<div key={i} style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '0 16px', borderRight: '1px solid var(--border)', whiteSpace: 'nowrap', fontFamily: "'DM Mono','Space Mono',monospace" }}>
...
//# sourceMappingURL=LiveTickerStrip.js.map