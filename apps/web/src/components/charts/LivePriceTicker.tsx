...
import type { LiveTicker } from '@/hooks/useLBankTicker'
...
export default function LivePriceTicker({ ticker, large = false }: Props) {
  ...
  return (
    <div style={{ display:'inline-flex', alignItems:'baseline', gap: large ? 12 : 6, padding:'4px 8px', borderRadius:8, background: flashColor, transition:'background 0.3s', fontFamily:"'DM Mono','Space Mono',monospace" }}>
