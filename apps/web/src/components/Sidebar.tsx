  ...
  return (
    <>
      ...
      <aside className="lb-sb flex flex-col shrink-0 border-r"
        ...
        {/* Logo */}
        <div className="flex items-center gap-3 px-[13px] py-[14px] border-b shrink-0"
            ...
            <button key={item.id} onClick={() => setActiveTab(item.id)}
              ...
              {item.badge && (
                <span className="lb-bdg"
                  style={{ fontSize:7, padding:'1px 5px', borderRadius:3, background:'var(--blue)', color:'#fff', fontFamily:'var(--font-mono)', flexShrink:0 }}>
                  {item.badge}
                </span>
              )}
            </button>
