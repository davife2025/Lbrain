...
class AlertEngine {
  ...
  private fired:    Set<string> = new Set() // track already-fired alerts this session
  ...
  private notify(alert: Alert, price: number) {
