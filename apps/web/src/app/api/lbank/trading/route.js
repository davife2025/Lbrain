...
import { LBankClient, placeOrder, cancelOrder, cancelAllOrders, getOpenOrders, getOrderHistory, getOrder, } from '@lbrain/lbank-skills';
...
export async function POST(req) {
    ...
    if (!creds)
        return NextResponse.json({ error: 'LBank API key required' }, { status: 401 });
