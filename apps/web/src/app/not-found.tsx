...
export default function NotFound() {
  return (
    <div style={{ minHeight:'100vh', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', background:'#09090f', fontFamily:'var(--font-sans)', textAlign:'center', padding:24 }}>
      ...
      <Link href="/"
        style={{ padding:'8px 20px', borderRadius:8, background:'#1a6fff', color:'#fff', textDecoration:'none', fontSize:12, fontWeight:500 }}>
        Back to LBrain
      </Link>
    </div>
  )
